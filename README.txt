...
* (1 point) Draw a line (e.g., a dotted black line, a solid red line)
  dividing the playing surface, as in the real game of Pong. -- DONE
...
* (1 point) Change the source so if the ball hits a wall (i.e.,
  ...
  and move the ball to the player who got scored on. -- DONE
...
paddle -- DONE, OR (1 point + 1 bonus point) make the opponent paddle play on
